...
<main className="relative h-screen overflow-hidden bg-gray-600 dark:bg-gray-800">
    <div className="flex items-start justify-between">
        <div className="relative hidden h-screen shadow-lg lg:block w-80">
            <div className="h-full bg-white dark:bg-gray-700">
                ...
                <nav className="mt-6">
                    <div>
                        <Link className="flex items-center justify-start w-full p-2 pl-6 my-2 text-gray-800 transition-colors duration-200 border-l-4 border-purple-500 dark:text-white" href="/">
                        ...
                        <Link className="flex items-center justify-start w-full p-2 pl-6 my-2 text-gray-400 transition-colors duration-200 border-l-4 border-transparent hover:text-gray-800" href="#">
                            <span className="text-left">
        ...
        <div className="flex flex-col w-full md:space-y-4">
                ...
                <div className="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
                    <div className="relative flex items-center justify-end w-full p-1 space-x-4">
                        ...
                        <Link href="#" className="relative block">
                            <img alt="profil" src="/imgs/perfil2.jpg" className="mx-auto object-cover rounded-full h-10 w-10 "/>
                        </Link>
            ...
            <div className="h-screen px-4 pb-24 overflow-auto md:px-6">
                ...
                <h2 className="text-gray-400 text-md">
                    Here&#x27;s what&#x27;s happening with your Admin account today.
                </h2>
